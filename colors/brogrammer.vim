...
hi MatchParen ctermfg=9 ctermbg=NONE cterm=underline guifg=#ff0000 guibg=NONE gui=underline
...
hi Conditional ctermfg=9 ctermbg=NONE cterm=bold guifg=#ff0000 guibg=NONE gui=bold
hi Constant ctermfg=62 ctermbg=NONE cterm=NONE guifg=#6c71c4 guibg=NONE gui=NONE
hi Define ctermfg=9 ctermbg=NONE cterm=bold guifg=#ff0000 guibg=NONE gui=bold
...
hi WarningMsg ctermfg=15 ctermbg=9 cterm=NONE guifg=#ffffff guibg=#ff0000 gui=NONE
...
hi Keyword ctermfg=9 ctermbg=NONE cterm=bold guifg=#ff0000 guibg=NONE gui=bold
...
hi Operator ctermfg=9 ctermbg=NONE cterm=bold guifg=#ff0000 guibg=NONE gui=bold
hi PreProc ctermfg=9 ctermbg=NONE cterm=bold guifg=#ff0000 guibg=NONE gui=bold
...
hi Statement ctermfg=9 ctermbg=NONE cterm=bold guifg=#ff0000 guibg=NONE gui=bold
...
hi SpellBad term=reverse ctermfg=9 ctermbg=224 gui=undercurl guisp=Red
hi rubyClass ctermfg=9 ctermbg=NONE cterm=bold guifg=#ff0000 guibg=NONE gui=bold
...
hi rubyInclude ctermfg=9 ctermbg=NONE cterm=bold guifg=#ff0000 guibg=NONE gui=bold
...
hi rubyControl ctermfg=9 ctermbg=NONE cterm=bold guifg=#ff0000 guibg=NONE gui=bold
hi rubyClassVariable ctermfg=172 ctermbg=NONE cterm=NONE guifg=#e67e22 guibg=NONE gui=NONE
hi rubyOperator ctermfg=9 ctermbg=NONE cterm=bold guifg=#ff0000 guibg=NONE gui=bold
hi rubyException ctermfg=9 ctermbg=NONE cterm=bold guifg=#ff0000 guibg=NONE gui=bold
...
hi htmlTag ctermfg=9 ctermbg=NONE cterm=NONE guifg=#ff0000 guibg=NONE gui=NONE
hi htmlEndTag ctermfg=9 ctermbg=NONE cterm=NONE guifg=#ff0000 guibg=NONE gui=NONE
hi htmlTagName ctermfg=9 ctermbg=NONE cterm=NONE guifg=#ff0000 guibg=NONE gui=NONE
hi htmlArg ctermfg=9 ctermbg=NONE cterm=NONE guifg=#ff0000 guibg=NONE gui=NONE
